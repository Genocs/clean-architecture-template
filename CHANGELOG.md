...
### [v5.0.0](https://github.com/Genocs/clean-architecture-template/compare/v4.0.0...v5.0.0)

> 25 January 2026

- Features/net10 [`#89`](https://github.com/Genocs/clean-architecture-template/pull/89)
- Bump MassTransit.RabbitMQ from 8.5.5 to 8.5.7 [`#84`](https://github.com/Genocs/clean-architecture-template/pull/84)
- Documentation request: Repository description provided [`#83`](https://github.com/Genocs/clean-architecture-template/pull/83)
- Bump Microsoft.EntityFrameworkCore.Tools from 9.0.10 to 9.0.11 [`#81`](https://github.com/Genocs/clean-architecture-template/pull/81)
- Bump Microsoft.EntityFrameworkCore.SqlServer from 9.0.10 to 9.0.11 [`#80`](https://github.com/Genocs/clean-architecture-template/pull/80)
- Bump Microsoft.EntityFrameworkCore.InMemory from 9.0.10 to 9.0.11 [`#79`](https://github.com/Genocs/clean-architecture-template/pull/79)
- Bump Microsoft.AspNetCore.Mvc.Testing from 9.0.10 to 9.0.11 [`#78`](https://github.com/Genocs/clean-architecture-template/pull/78)
- Bump MassTransit.RabbitMQ from 8.5.4 to 8.5.5 [`#76`](https://github.com/Genocs/clean-architecture-template/pull/76)
- Bump Rebus.RabbitMq from 10.0.3 to 10.1.0 [`#77`](https://github.com/Genocs/clean-architecture-template/pull/77)
- Bump NServiceBus.RabbitMQ from 10.1.3 to 10.1.4 [`#72`](https://github.com/Genocs/clean-architecture-template/pull/72)
- Add devcontainer configuration for Azure Developer CLI with .NET and Docker support [`239e796`](https://github.com/Genocs/clean-architecture-template/commit/239e79645d3ecb00dd3d16dc9e37634292b7b92b)
- Update README_NUGET.md to enhance project description and features [`01deaf8`](https://github.com/Genocs/clean-architecture-template/commit/01deaf811b2a8620ba9237ccec69b3043b435afe)
- Refactor NuGet publishing workflow to use dotnet pack, remove obsolete files, and update README instructions [`0a7ea3a`](https://github.com/Genocs/clean-architecture-template/commit/0a7ea3ab14eca8c59cabbe98713bde36065c4a24)
- Update project to .NET 10, adjust dependencies, and revise documentation [`30ea3a3`](https://github.com/Genocs/clean-architecture-template/commit/30ea3a38ce95de7de84866a347ec2e5bd3044109)
- Update template version to 5.0.0, add custom operations, and restructure solution files [`ca9ad34`](https://github.com/Genocs/clean-architecture-template/commit/ca9ad349b95893de1a777c85d323166c1ab732d4)
- Update CHANGELOG.md for version 4.0.0 with recent changes and improvements [`caba3bf`](https://github.com/Genocs/clean-architecture-template/commit/caba3bfc1757a91b91c09a74f1e784f00b852beb)
- Update Dockerfiles and project files for .NET 10 compatibility, add Docker commands to README [`36cdda3`](https://github.com/Genocs/clean-architecture-template/commit/36cdda39cb052dba2edc72912e2dff7ed1ea1366)
- Refactor and improve code consistency [`b025dcf`](https://github.com/Genocs/clean-architecture-template/commit/b025dcf07cf51ad90a1bcb03c3aeb55ef78f1037)
- Enhance project structure by adding NServiceBus support, refactoring templates, and removing obsolete files [`b342b32`](https://github.com/Genocs/clean-architecture-template/commit/b342b324f9bcb022cdd07db0acbd0f7d80b6a414)
- Upgrade dependencies and fix changelog link [`44d2014`](https://github.com/Genocs/clean-architecture-template/commit/44d2014877132df8967b4a97a5edc5638315250e)
- Update project to .NET 10, adjust project paths in documentation and Dockerfiles [`c6e4efe`](https://github.com/Genocs/clean-architecture-template/commit/c6e4efef3a2b8f672cd12696289e78cd520f59a5)
- Fix typos and enhance README documentation for .NET 10 SDK and installation instructions [`4116ff7`](https://github.com/Genocs/clean-architecture-template/commit/4116ff78df721a5e34ac45b319308c2adf25574a)
- Update package version to 4.0.1 in README and project files, and adjust NuGet publish workflow default version [`317a94d`](https://github.com/Genocs/clean-architecture-template/commit/317a94df33c717098bdf0d80d734497b9606d2eb)
- Refactor Dockerfiles to conditionally include NServiceBus project references [`fa09e05`](https://github.com/Genocs/clean-architecture-template/commit/fa09e0501887ca0939269b5936bdf9643eec2dc9)
- Update package version to 5.0.0 in project files and documentation [`9712413`](https://github.com/Genocs/clean-architecture-template/commit/97124133d8e52b297d80641c83aa247622c7603e)
- Update GitHub Actions workflows for .NET 10 compatibility and version bump [`beca898`](https://github.com/Genocs/clean-architecture-template/commit/beca8982979012420eb3f362f4a5c46642944814)
- Implement code changes to enhance functionality and improve performance [`1eccbb6`](https://github.com/Genocs/clean-architecture-template/commit/1eccbb60d1d51b8d304a0ec5ce353b8f6dccb1db)
- Update authorization header in Auth API client and improve health check comment [`db7c21e`](https://github.com/Genocs/clean-architecture-template/commit/db7c21e8262f992eac9f7cbec9c7684faa659d5a)
- Update EntityFrameworkCore.SqlServer to version 9.0.11 [`3d23b21`](https://github.com/Genocs/clean-architecture-template/commit/3d23b2143cb7b311655ba5ba20a1977e63fba5a4)
- Fix Dockerfile path for Application project reference [`7c6b8ad`](https://github.com/Genocs/clean-architecture-template/commit/7c6b8adda7fd7e87a62ec80043682d8d6bb5b579)
- Update README.md [`dc24f5a`](https://github.com/Genocs/clean-architecture-template/commit/dc24f5af80b3bf5affe4b14be783af9f0b08cf49)
- Update src/Package.Template.csproj [`00a979b`](https://github.com/Genocs/clean-architecture-template/commit/00a979b263f4e55ff1f40ddfb3f31d8407b8f1d4)
- Update src/README_NUGET.md [`85ab4d6`](https://github.com/Genocs/clean-architecture-template/commit/85ab4d6beedb99c5d810715f8293e70e02600ee2)
- Initial plan [`01010eb`](https://github.com/Genocs/clean-architecture-template/commit/01010eb1ac34056cfb6c52258fac3071c0e5b026)
- Fix path in NuGet pack command to ensure correct packaging of the template project [`d38554f`](https://github.com/Genocs/clean-architecture-template/commit/d38554f7eaa31b805063a70f13cdc780d77c2035)
